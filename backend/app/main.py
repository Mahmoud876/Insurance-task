...
app.include_router(
    claims_router,
    prefix="/api/v1",
    dependencies=[Depends(get_auth_context), Depends(get_tenant_context)],
)
app.include_router(
    attachments_router,
    prefix="/api/v1",
...
app.include_router(
    ocr_router, prefix="/api", dependencies=[Depends(get_auth_context), Depends(get_tenant_context)]
)
app.include_router(
    preauth_router,
    prefix="/api",
