...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DentalClaimsEngine.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new DentalClaimsEngine.ValidationError();
      //expect(instance).to.be.a(DentalClaimsEngine.ValidationError);
    });
