...
from app.domain.constants import DEFAULT_CODE_SETS
from app.domain.enums import AgeStrategyType, ProcedureCategory
from app.domain.normalization.date import normalize_date
from app.domain.rules.registry import OperatorRegistry
from app.domain.strategies.age import (
    AGE_STRATEGIES,
    AgeCalculationStrategy,
    exact_age_strategy,
)
from app.domain.tooth_num import parse_fdi
